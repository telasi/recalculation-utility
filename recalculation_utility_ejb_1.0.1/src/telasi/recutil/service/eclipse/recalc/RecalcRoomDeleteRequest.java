...
/**
 * Request for recalculation room item DELETE.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Dec, 2006
 */
public class RecalcRoomDeleteRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = 2220487378572121117L;

	private RecalcRoomItem item;

	public RecalcRoomDeleteRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_ROOM_DELETE, userName, password);
	}
