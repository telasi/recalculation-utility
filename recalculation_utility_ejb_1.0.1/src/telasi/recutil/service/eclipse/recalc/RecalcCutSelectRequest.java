 ...
 */
public class RecalcCutSelectRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -1171397409163943909L;

	private Recalc recalc;

	private List cuts;

	public RecalcCutSelectRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_CUT_SELECT, userName, password);
	}
