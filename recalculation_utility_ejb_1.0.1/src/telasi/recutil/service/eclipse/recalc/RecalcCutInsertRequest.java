 ...
 */
public class RecalcCutInsertRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -40161749955500055L;
	...
	public RecalcCutInsertRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_CUT_INSERT, userName, password);
	}
