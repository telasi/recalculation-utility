...
/**
 * Request for recalculation regular item MOVE.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Nov, 2006
 */
public class RecalcRegularMoveRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -8039845980278984269L;

	private RecalcRegularItem item;

	private boolean up;

	public RecalcRegularMoveRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_REGULAR_MOVE, userName, password);
	}
