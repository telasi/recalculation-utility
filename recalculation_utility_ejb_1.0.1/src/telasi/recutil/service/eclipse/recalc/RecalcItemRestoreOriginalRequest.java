...
/**
 * Request for recalculation item originals RESTORE.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Nov, 2006
 */
public class RecalcItemRestoreOriginalRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -7575973032439456748L;

	private RecalcItem item;

	private int option;

	public RecalcItemRestoreOriginalRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_ITEM_RESTORE_ORIGINAL, userName,
				password);
	}
