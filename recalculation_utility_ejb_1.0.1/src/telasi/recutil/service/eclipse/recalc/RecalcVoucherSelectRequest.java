 ...
 */
public class RecalcVoucherSelectRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -3393881101924249157L;

	private Recalc recalc;

	private RecalcVoucher voucher;

	public RecalcVoucherSelectRequest(String userName, String password) {
