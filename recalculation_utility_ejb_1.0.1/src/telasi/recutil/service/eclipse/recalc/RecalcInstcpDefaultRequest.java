...
/**
 * Request for recalculation DEFAULT generation installed capacity history.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Nov, 2006
 */
public class RecalcInstcpDefaultRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -6865197243985987994L;

	private Recalc recalc;

	public RecalcInstcpDefaultRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_INSTCP_DEFAULT, userName, password);
	}
