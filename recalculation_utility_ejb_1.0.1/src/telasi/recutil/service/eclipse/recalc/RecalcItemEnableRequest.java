...
/**
 * Request for recalculation item ENABLE/DISABLE.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Nov, 2006
 */
public class RecalcItemEnableRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -4950263840223920948L;

	private RecalcItem item;

	private boolean enabled;

	public RecalcItemEnableRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_ITEM_ENABLE, userName, password);
	}
