...
/**
 * Request for recalculation cut item UPDATE.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Dec, 2006
 */
public class RecalcRoomUpdateRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = 7985286502534041752L;

	private RecalcRoomItem item;

	public RecalcRoomUpdateRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_ROOM_UPDATE, userName, password);
	}
