 ...
 */
public class RecalcCutUpdateRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -8614223941580568373L;

	private RecalcCutItem item;

	public RecalcCutUpdateRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_CUT_UPDATE, userName, password);
	}
