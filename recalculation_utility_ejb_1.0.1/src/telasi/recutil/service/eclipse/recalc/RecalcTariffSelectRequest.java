...
/**
 * Request for recalculation tariff history SELECT.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Nov, 2006
 */
public class RecalcTariffSelectRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = 6038278869097608133L;

	private Recalc recalc;

	private List tariffs;

	public RecalcTariffSelectRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_TARIFF_SELECT, userName, password);
	}
