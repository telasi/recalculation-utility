...
/**
 * Request for recalculation tariff item MOVE.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Dec, 2006
 */
public class RecalcTariffMoveRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = 7961012325324866540L;

	private RecalcTariffItem item;

	private boolean up;

	public RecalcTariffMoveRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_TARIFF_MOVE, userName, password);
	}
