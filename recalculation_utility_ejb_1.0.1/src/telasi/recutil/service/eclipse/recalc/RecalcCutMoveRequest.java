...
/**
 * Request for recalculation cut item MOVE.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Dec, 2006
 */
public class RecalcCutMoveRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -2013933342960035425L;

	private RecalcCutItem item;

	private boolean up;

	public RecalcCutMoveRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_CUT_MOVE, userName, password);
	}
