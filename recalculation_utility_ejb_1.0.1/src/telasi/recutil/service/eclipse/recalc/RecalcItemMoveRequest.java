...
/**
 * Request for recalculation item MOVE.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Nov, 2006
 */
public class RecalcItemMoveRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -1610605943618649678L;

	private RecalcItem item;

	private boolean up;

	public RecalcItemMoveRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_ITEM_MOVE, userName, password);
	}
