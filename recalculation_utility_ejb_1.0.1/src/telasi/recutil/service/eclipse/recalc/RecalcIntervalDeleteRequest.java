...
/**
 * Request for recalculation interval DELETE.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Nov, 2006
 */
public class RecalcIntervalDeleteRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = 4952908574521112457L;

	private RecalcInterval recalcInterval;

	public RecalcIntervalDeleteRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_INTERVAL_DELETE, userName, password);
	}
