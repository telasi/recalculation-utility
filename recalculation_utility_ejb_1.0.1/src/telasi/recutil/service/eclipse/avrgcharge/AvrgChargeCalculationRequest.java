 ...
 */
public class AvrgChargeCalculationRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = 6092645776843065538L;

	private Recalc recalc;

	private List results;

	public AvrgChargeCalculationRequest(String userName, String password) {
		super(ActionConstants.OTHER_AVRG_CHARGE_CALCULATION, userName, password);
	}
