...
public class TpOwnerRecalcSaveRequest extends DefaultEJBRequest {
	...
	public TpOwnerRecalcSaveRequest(String userName, String password) {
		super(ActionConstants.ACT_TPOWNER_RECALCULATION_SAVE, userName, password);
	}
