...
public class JBossConnectionEditor extends Dialog {
	...
	private JBossConnectionDescriptor descriptor;

	public JBossConnectionEditor(Shell parent, int style) {
		super(parent, style);
	}
	...
	public void open() {
		try {
			...
			dialogShell.layout();
			dialogShell.setText(GUIMessages.getMessage("comp.url.properties.jboss.title"));
			{
				...
				composite1.setLayout(composite1Layout);
				{
					...
					lblImage.setImage(Plugin.getImage("icons/other/jboss.png"));
				}
				{
	...
	private void reset() {
		if (descriptor == null) {
			descriptor = new JBossConnectionDescriptor();
		}
	...
	public void setDescriptor(ConnectionDescriptor descriptor) {
		if (!(descriptor instanceof JBossConnectionDescriptor))
			throw new IllegalArgumentException();
		this.descriptor = (JBossConnectionDescriptor)descriptor;
	}
