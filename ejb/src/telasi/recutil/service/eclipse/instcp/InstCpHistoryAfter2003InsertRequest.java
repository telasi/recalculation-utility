...
public class InstCpHistoryAfter2003InsertRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -6236256780156215181L;

	public InstCpHistoryAfter2003InsertRequest(String userName, String password) {
		super(ActionConstants.OTHER_INST_CP_HISTORY_AFTER_2003_INSERT,
				userName, password);
	}
