 ...
 */
public class RoleUpdateRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = 1763532049558123963L;

	private Role role;

	public RoleUpdateRequest(String userName, String password) {
		super(ActionConstants.ACT_ROLE_UPDATE, userName, password);
	}
