 ...
 */
public class ConnectRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -4306343749834415630L;

	private long userId = -1;

	public ConnectRequest(String userName, String password) {
		super(ActionConstants.ACT_CONNECT, userName, password);
	}
