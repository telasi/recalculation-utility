 ...
 */
public class RoleInsertRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = 2311317422804361361L;

	private Role role;

	private long id;

	public RoleInsertRequest(String userName, String password) {
		super(ActionConstants.ACT_ROLE_INSERT, userName, password);
	}
