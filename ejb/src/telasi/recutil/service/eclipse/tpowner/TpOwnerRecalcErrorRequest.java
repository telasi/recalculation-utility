...
public class TpOwnerRecalcErrorRequest extends DefaultEJBRequest {
	private static final long serialVersionUID = 287845231255675278L;

	private int accountId;
	private Date cycleDate;

	public TpOwnerRecalcErrorRequest(String userName, String password) {
		super(ActionConstants.ACT_TPOWNER_RECALCULATION_DECLARE_ERROR, userName, password);
	}
