...
/**
 * Request for recalculation cut item INSERT.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Dec, 2006
 */
public class RecalcRoomInsertRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = 2914252833967530996L;
	...
	public RecalcRoomInsertRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_ROOM_INSERT, userName, password);
	}
