...
/**
 * Request for recalculation unblock.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Dec, 2006
 */
public class RecalcUnblockRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -8710318720321632152L;

	private long recalcId;

	public RecalcUnblockRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_UNBLOCK, userName, password);
	}
