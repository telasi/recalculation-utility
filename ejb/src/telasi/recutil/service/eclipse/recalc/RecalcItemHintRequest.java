...
/**
 * Request for recalculation item LOCK.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Nov, 2006
 */
public class RecalcItemHintRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -2922846925160103793L;

	private RecalcItem item;

	private int hint;

	public RecalcItemHintRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_ITEM_HINT, userName, password);
	}
