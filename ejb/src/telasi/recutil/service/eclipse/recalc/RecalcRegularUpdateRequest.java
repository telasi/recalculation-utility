...
/**
 * Request for recalculation regular item UPDATE.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Nov, 2006
 */
public class RecalcRegularUpdateRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = 1378950569620899299L;

	private RecalcRegularItem item;

	public RecalcRegularUpdateRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_REGULAR_UPDATE, userName, password);
	}
