...
/**
 * Request for recalculation COPY.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Dec, 2008
 */
public class RecalcCopyRequest extends DefaultEJBRequest {
	private static final long serialVersionUID = 7224388297443046345L;

	private long id;
	private Recalc recalculation;
	private User user;

	public RecalcCopyRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_COPY, userName, password);
	}
