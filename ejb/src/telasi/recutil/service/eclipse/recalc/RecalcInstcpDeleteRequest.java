...
/**
 * Request for recalculation inst.cp. item DELETE.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Nov, 2006
 */
public class RecalcInstcpDeleteRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -8287364076165313352L;

	private RecalcInstCp item;

	public RecalcInstcpDeleteRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_INSTCP_DELETE, userName, password);
	}
