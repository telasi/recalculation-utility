...
/**
 * Request for recalculation tariff item DELETE.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Dec, 2006
 */
public class RecalcTariffDeleteRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -1952018106711453324L;

	private RecalcTariffItem item;

	public RecalcTariffDeleteRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_TARIFF_DELETE, userName, password);
	}
