 ...
 */
public class RecalcItemMeterUpdateRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -8032516766092463789L;
	...
	private double meterCoeff, meterAcceleration;

	public RecalcItemMeterUpdateRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_ITEM_METER_UPDATE, userName, password);
	}
