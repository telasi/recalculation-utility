...
/**
 * Request for recalculation item INSERT.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Nov, 2006
 */
public class RecalcItemInsertRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -4165944832153323896L;
	...
	public RecalcItemInsertRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_ITEM_INSERT, userName, password);
	}
