...
/**
 * Request for recalculation item DELETE.
 * 
 * @author <a href="mailto:dimakura@dev.java.net">Dimitri Kurashvili</a>
 * @version 1.0.0 Nov, 2006
 */
public class RecalcItemDeleteRequest extends DefaultEJBRequest {

	private static final long serialVersionUID = -3555317024261008096L;

	private RecalcItem item;

	public RecalcItemDeleteRequest(String userName, String password) {
		super(ActionConstants.ACT_RECALC_ITEM_DELETE, userName, password);
	}
